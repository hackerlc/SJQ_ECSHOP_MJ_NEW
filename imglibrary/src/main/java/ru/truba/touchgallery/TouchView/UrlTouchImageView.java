...
public class UrlTouchImageView extends RelativeLayout {
    ...
    protected void init() {
        ...
        mProgressBar.setBackgroundResource(R.drawable.progressbardialog_bg);
        mProgressBar.setIndeterminateDrawable(mContext.getResources().getDrawable(R.drawable.progress_large));
