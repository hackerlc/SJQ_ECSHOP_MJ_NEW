...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mGoods = (Goods) fragmentArgs.getSerializable(EaseConstant.EXTRA_GOODS);
    ...
    protected void initView() {
        ...
        vs_goods_link = getView().findViewById(R.id.vs_goods_link);
        if(mGoods != null && (mGoods.getName() != null || "".equals(mGoods.getName()))){
            //商品咨询
            vs_goods_link.setVisibility(View.VISIBLE);
            goodsTitle = (TextView) getView().findViewById(R.id.consult_goods_title);
            goodsPrice = (TextView) getView().findViewById(R.id.consult_goods_price);
            goodsUrl = (TextView) getView().findViewById(R.id.consult_goods_sendurl);
            goodsImg = (ImageView) getView().findViewById(R.id.consult_goods_img);
            goodsTitle.setText(mGoods.getName());
            goodsPrice.setText("￥"+mGoods.getPrice());
            Glide.with(getContext()).load(mGoods.getImg()).into(goodsImg);
            titleBar.setTitle(mGoods.getHxName());
            goodsUrl.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    sendTextMessage(mGoods.getHxString());
                }
            });
        } else {
            vs_goods_link.setVisibility(View.GONE);
        }
