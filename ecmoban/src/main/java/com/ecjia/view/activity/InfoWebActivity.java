...
public class InfoWebActivity extends BaseActivity implements HttpResponse {
    ...
    public void onMessageResponse(String url, JSONObject jo, STATUS status) throws JSONException {
        if (url == ProtocolConst.SHOP_INFO_DETAIL) {
            if (status.getSucceed() == 1) {
                webView.loadDataWithBaseURL(null, infoModel.web, "text/html", "utf-8", null);
            }
        }
    }
