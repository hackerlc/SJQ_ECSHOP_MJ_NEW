...
public class NewWholesaleAdapter extends HeaderFooterLoadMoreAdapter<ShopInfo> {
    protected Context mContext;
    protected OnClickFollow mOnClickFollow;

    public NewWholesaleAdapter(Context context, List<ShopInfo> datas, OnClickFollow clickFollow) {
