 ...
 */
public class ShoppingCartActivity extends BaseActivity implements IXListViewListener {
    ...
    private LinearLayout buttomitem, buttomleft, buttomright;
    ...
    private ArrayList<GOODS_LIST> cachelist = new ArrayList<GOODS_LIST>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        footer_balance2 = (LinearLayout) findViewById(R.id.shop_car_footer_balance2);
        buttomleft = (LinearLayout) findViewById(R.id.shop_car_buttomleft);
        buttomright = (LinearLayout) findViewById(R.id.shop_car_buttomright);
        shopcar_go_home = (TextView) findViewById(R.id.shopcar_go_home);
        shopcar_delete = (TextView) findViewById(R.id.shop_car_footer_delete);

        checkallitem = (LinearLayout) findViewById(R.id.cart_checkall_item);
        checkBoxall = (CheckBox) findViewById(R.id.cart_checkall_check);
        ...
        xlistView = (XListView) findViewById(R.id.shop_car_list);
        ...
        if (shopCarAdapter == null) {
            shopCarAdapter = new ShoppingCartAdapter(this, shoppingCartModel.newcartList, 1);
        }
        ...
        //获取页脚所需数据
        new HomeModel(this).readHomeDataCache();
        //添加页脚（你可能会喜欢）
        buttomview = LayoutInflater.from(this).inflate(R.layout.shopcart_buttomview, null);
        ...
        for (int i = 0; i < mylist.size(); i++) {
            View view = this.getLayoutInflater().inflate(R.layout.youlike_item, null);
            ...
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    startActivity(new Intent(ShoppingCartActivity.this, GoodsDetailActivity.class).putExtra("good_id", listData.get(Integer.valueOf((String) view.getTag())).getId()));
                }
            });
            pagerList.add(view);
        }

        youLikeAdapter = new YouLikeAdapter(this, pagerList);
        ...
        footer_total = (TextView) findViewById(R.id.shop_car_footer_total);
        footer_balance = (TextView) findViewById(R.id.shop_car_footer_balance);
        footer_totalno = (TextView) findViewById(R.id.shop_car_totalno);
        buttomitem = (LinearLayout) findViewById(R.id.shop_car_buttomitem);
        ...
        footer_balance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (buylist.size() > 0) {
                    ...
                    ToastView toastView = new ToastView(ShoppingCartActivity.this, res.getString(R.string.choose_nothing));
                    toastView.show();
                }
        ...
        //为空时增加去逛逛按钮
        shopcar_go_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // 跳转至首界面
        ...
        shopcar_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (deleteList.size() > 0) {
                    final MyDialog dialog = new MyDialog(ShoppingCartActivity.this, delete, shopcar_deletes);
                    dialog.show();
                    dialog.positive.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            ToastView toast = new ToastView(ShoppingCartActivity.this, deletesuccess);
                            toast.show();
                            deleteGood();
                            dialog.dismiss();
                        }
        ...
        if (url.equals(ProtocolConst.ADDRESS_LIST)) {
            if (status.getSucceed() == 1) {
                if (addressModel.addressList.size() == 0) {
                    String main = res.getString(R.string.point);
                    String main_content = res.getString(R.string.address_add_first);
                    ...
                    Intent intent = new Intent(ShoppingCartActivity.this, NewBalanceActivity.class);
                    ...
                    ShoppingCartActivity.this.overridePendingTransition(R.anim.push_right_in,
    ...
    private void toAddAddress() {
        Intent intent = new Intent(ShoppingCartActivity.this, AddressAddActivity.class);
