...
public class HomeShopListAdapter extends BaseAdapter {
    ...
    public HomeShopListAdapter(Context context, ArrayList<SELLERINFO> sellerlist, int width) {
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        ...
        float distance= FormatUtil.formatStrToFloat(sellerinfo.getDistance());
        if(0==distance){
            holder.tv_seller_distance.setText("");
        }else{
            if(distance<1000){
                holder.tv_seller_distance.setText((int)distance+"m");
            }else {
                holder.tv_seller_distance.setText(FormatUtil.formatFloatTwoDecimal(distance/1000)+"km");
            }
