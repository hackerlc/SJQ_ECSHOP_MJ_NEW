...
public class SelectableRoundedImageView extends ImageView {
    ...
    private Drawable resolveResource() {
        ...
        if (mResource != 0) {
            try {
                ...
                Log.i(TAG, "Unable to find resource: " + mResource, e);
                // Don't try again.
                mResource = 0;
            }
        }
    ...
    /**
     * Set radius for each corner without calculate density.
     *
     * @param leftTop
     * @param rightTop
     * @param leftBottom
    ...
    public void setCornerRadius(float leftTop, float rightTop, float leftBottom, float rightBottom) {
        ...
        final float lt = leftTop;
        final float rt = rightTop;
        final float lb = leftBottom;
        final float rb = rightBottom;
