...
public class MyXListView extends ListView implements OnScrollListener {
    ...
    public void setPullLoadEnable(boolean enable, boolean hidefooter) {
        mEnablePullLoad = enable;
        if (!mEnablePullLoad) {
            mFooterView.hide();
            mFooterView.setOnClickListener(null);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if(mHeaderView.getVisiableHeight()==0&&deltaY<0){//向下滑动
                    if (null != titleView) {
                        titleView.setVisibility(VISIBLE);
                    }
                }
            ...
            default:
                ...
                if (getFirstVisiblePosition() == 0) {
                    ...
                    if (null != titleView&&mHeaderView.getVisiableHeight()==0&&!mPullRefreshing) {
                        titleView.setVisibility(VISIBLE);
                    }
                    resetHeaderHeight();
                } else if (getLastVisiblePosition() == mTotalItemCount - 1) {
