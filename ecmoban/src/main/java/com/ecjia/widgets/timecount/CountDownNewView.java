 ...
 * 有天倒计时的View
 */
public class CountDownNewView extends LinearLayout {
    ...
    public CountDownNewView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initView(Context context) {
        ...
        View view = inflater.inflate(R.layout.layout_countdown_new_layout, this);
