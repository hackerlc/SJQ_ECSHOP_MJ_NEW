package com.ecjia.widgets.xlratingbar;
...
public class XLHRatingBar extends LinearLayout {
    ...
    public XLHRatingBar(Context context, AttributeSet attrs) {
        ...
        widthAndHeight = typedArray.getDimension(R.styleable.XlHRatingBar_widthAndHeight, UnitUtil.dp2Px(context, 0));
        dividerWidth = typedArray.getDimension(R.styleable.XlHRatingBar_newDividerWidth, UnitUtil.dp2Px(context, 0));
