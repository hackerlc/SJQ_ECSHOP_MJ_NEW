...
public class BottomChoosePhotoUtils extends BottomSheetDialogFragment {
    ...
    public void setupDialog(final Dialog dialog, int style) {
        ...
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.activity_editheadpicture, null, false);

        view.findViewById(R.id.editheadpicture_take_photo).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        view.findViewById(R.id.editheadpicture_from_photos).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openDcimMuti(count);
                dialog.dismiss();
        ...
        view.findViewById(R.id.editheadpicture_cancle).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog.dismiss();
            }
