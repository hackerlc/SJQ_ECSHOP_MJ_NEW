...
//                .setCheckNornalColor(R.color.colorAccent)//选择框未选颜色
                .setPreviewBg(context.getResources().getDrawable(R.drawable.account_pig))//设置预览页背景
...
//        ImageLoader imageLoader = new UILImageLoader();
        ...
        CoreConfig coreConfig = new CoreConfig.Builder(context, imageLoader, theme)
                ...
                .setEditPhotoCacheFolder(new File(Environment.getExternalStorageDirectory(), "/DCIM/" + "ecjia/"))
                .setTakePhotoFolder(new File(Environment.getExternalStorageDirectory(), "/DCIM/" + "ecjia/"))
                .build();
